...
{
	public partial class StationInfoControl3 : DevExpress.XtraEditors.XtraUserControl
	{
		...
		private void GetDataValue()
		{
			...
			//BindingList<Models.AddWorkstation> addWorkstations = m_AddWorkstationDao.GetDataSource();
			...
			{
				Models.AddWorkstation addWorkstation = addWorkstations.FirstOrDefault(a => a.AreaNo == 1);
